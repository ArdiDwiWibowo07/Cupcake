...
class StartFragment : Fragment() {
    ...
    // Binding objek instance  sesuai  layout fragment_start.xml
    ...
    /**
     * Mulai pesanan dengan jumlah cupcake yang diinginkan dan arahkan ke layar berikutnya.
     */

    fun orderCupcake(quantity: Int) {
        // Memperbarui view model dengan quantity
        sharedViewModel.setQuantity(quantity)

        // Select vanila jika tidak diset rasa
        if (sharedViewModel.hasNoFlavorSet()) {
            sharedViewModel.setFlavor(getString(R.string.vanilla))
        }

        // Arahkan halaman berikutnya untuk memilih rasa cupcakes
